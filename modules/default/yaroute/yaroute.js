...
Module.register("yaroute", 
{
    ...
    getDom: function () 
	{
        ...
        var wrapper = document.createElement("div");
			...
			wrapper.style.webkitFilter = "grayscale(1) invert(100%) contrast(200%) brightness(200%)";
		...
		function initYandexMap()
		{
			...
			function getRoutes()
			{
				...
				myRoute.model.events.add('requestsuccess', function() 
				{
					...
					clearInfo();
					addInfo(activeRoute.properties.get("distance").text, activeRoute.properties.get("durationInTraffic").text);
				}); 
			...
			if(self.config.refreshPeriod)
			{
                ...
                self.state.refreshTimer = setInterval( getRoutes, 1000 * 60 * self.config.refreshPeriod );
            }   
